<template>
  <div>
    ...
    <div>
      <v-btn @click="toggleMelody()" large tile text outlined color="teal">
        🎹 Melody
      </v-btn>
      <v-btn @click="toggleBass()" large tile text outlined color="teal">
        🎸 Bass
      </v-btn>
      <v-btn @click="toggleNoise()" large tile text outlined color="teal">
        💨 Noise
      </v-btn>
      <v-btn
      ...
      <v-btn @click="speedUpBpm()" large tile text outlined color="teal">
        👟 Speed up
      </v-btn>
      <v-btn @click="stopInstruments()" large tile text outlined color="teal">
        ✋ Stop
      </v-btn>
    </div>
  </div>
